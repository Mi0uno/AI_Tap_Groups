...
| 项目效果                                                                       | 扩展配置与分组状态                                                                           |
| ------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------- |
| [![GitHub 项目页](docs/screenshots/demo.png)](docs/screenshots/github-overview.png) | [![扩展配置与分组状态](docs/screenshots/popup-settings.png)](docs/screenshots/popup-settings.png) |
